...
* `ngmodel` is the directive which deals with two way data binding for more info please go for topic <a href='/#1. Overview/2 Core-Concepts/12. Data Binding'>Data Binding</a>
