Creates and wires objects and functions. The objects are dynamically injected and used where it is required instead of creating string coupling among needed modules.
