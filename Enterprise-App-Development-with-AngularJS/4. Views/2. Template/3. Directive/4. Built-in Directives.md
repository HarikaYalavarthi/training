* Angular comes with a set of these directives built-in, like ngBind, ngModel, and ngClass. Much like create controllers and services, own directives can be created for Angular to use.
